...
@patch("pysynthbio.call_model_api._get_json")
@patch("pysynthbio.call_model_api._poll_model_query")
@patch("pysynthbio.call_model_api._start_model_query")
@patch("pysynthbio.call_model_api.has_synthesize_token", return_value=True)
