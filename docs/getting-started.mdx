...
See [Baseline models](/python-sdk/models/baseline) for detailed usage.
...
See [Reference conditioning](/python-sdk/models/reference-conditioning) for detailed usage.
...
See [Metadata prediction](/python-sdk/models/metadata-prediction) for detailed usage.
...
Your IDE or terminal doesn't have access to Keychain. Open **System Preferences → Security & Privacy → Privacy → Full Disk Access** and add the terminal or IDE you're working from (Terminal, iTerm, VS Code, PyCharm, etc.).
