...
<Steps>
  <Step title="Find the release">
    Go to the [releases page](https://github.com/synthesizebio/pysynthbio/releases) and find the tag you want (e.g. `v3.0.2`).
  </Step>
...
<Card title="Next: Get started" icon="arrow-right" href="/python-sdk/getting-started">
