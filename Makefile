...
docs-strict:
	@echo "Building documentation with strict warnings-as-errors..."
...
.PHONY: help Makefile checks docs docs-live docs-strict docs-linkcheck docs-pdf docs-clean docs-all
